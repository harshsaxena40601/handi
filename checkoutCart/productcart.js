...
//   });
// }
// Improved cart.js with fixed empty cart functionality
document.addEventListener("DOMContentLoaded", function () {
  console.log("DOM loaded - initializing cart");
...
// Remove item from cart - FIXED FUNCTION
function removeItemFromCart(id) {
  console.log("Removing item from cart:", id);
  ...
  if (itemIndex !== -1) {
    // Remove the item from the cart array immediately
...
// Empty the entire cart - NEW FUNCTION
function emptyCart() {
  ...
  // Show notification
  showToast("Your cart has been emptied", "info");
}
...
function updateCartItemQuantity(id, quantity) {
  ...
  if (item) {
    ...
    // Update the displayed item total and quantity
    renderCartItems();
  }
}
...
function setupEventListeners() {
  ...
  // NEW: Add "Empty Cart" button to the cart summary
  ...
  if (cartSummary) {
    ...
    emptyCartBtn.style.width = "100%";
    emptyCartBtn.style.padding = "12px";
    emptyCartBtn.style.marginTop = "15px";
    emptyCartBtn.style.backgroundColor = "#f5f5f5";
    emptyCartBtn.style.color = "#333";
    emptyCartBtn.style.border = "none";
    emptyCartBtn.style.borderRadius = "8px";
    emptyCartBtn.style.fontWeight = "500";
    emptyCartBtn.style.cursor = "pointer";
    emptyCartBtn.style.transition = "all 0.3s";
    ...
    // Add button after checkout button
    ...
    if (checkoutButton) {
      ...
      cartSummary.appendChild(emptyCartBtn);
    }
  }
}
